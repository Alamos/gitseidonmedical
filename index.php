...
<html lang="en">
<head>
<title>Seidon Medical System</title>
<meta charset="UTF-8" />
...
<!--Header-part-->
<div id="header">
  <h1><a href="dashboard.html">Seidon Medical System</a></h1>
</div>
<!--close-Header-part--> 
...
<!--close-top-serch-->
<!--sidebar-menu-->
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Escritorio</a>
  <ul>
    <li class="active"><a href="index.html"><i class="icon icon-home"></i> <span>Escritorio</span></a> </li>
